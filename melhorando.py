...
with st.container():
    st.write("---")
    #Trabalho 1 
    st.write("👩🏻‍💻","**Analista de Redes** | Hypermatrix do Brasil")
    st.write("02/2025 - 07/2025")
    st.markdown(
        """
    ...
    #Trabalho 2 
    st.write("💼","**Supervisor** | Martinstec Manutenção e Reparos")
    st.write("09/2017 - 01/2025")
    st.markdown(
        """
    ...
    #Trabalho 3
    st.write("💼","**Supervisor de Qualidade** | Martinstec Manutenção e Reparos")
    st.write("06/2020 - 07/2021")
    st.markdown(
        """
    ...
    #Trabalho 4
    st.write("💼","**Auxiliar Técnico** | Martinstec Manutenção e Reparos")
    st.write("07/2017 - 06/2020")
    st.markdown(
        """
